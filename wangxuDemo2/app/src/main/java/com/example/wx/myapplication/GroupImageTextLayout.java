...
public class GroupImageTextLayout extends RelativeLayout {
    ...
    private void initializeAttrs(Context context, AttributeSet attrs) {
        ...
        Drawable imageBackgroundDrawable;
        Drawable textBackgroundDrawable;
        int scaleTypeIndex = -1;
        int textSize;
        String textString;
        ColorStateList textColor;
        int gravityIndex = 0;
        int textMarginImageSize;
        int viewMarginStart;
        ...
        viewMarginStart = a.getDimensionPixelOffset(R.styleable.GroupImageTextLayout_app_child_view_margin_start, 0);

        textMaxWidth= a.getDimensionPixelOffset(R.styleable.GroupImageTextLayout_app_text_max_width, -1);
        ...
        isSingleLine = a.getBoolean(R.styleable.GroupImageTextLayout_app_text_single_line, false);
        maxLine = a.getInt(R.styleable.GroupImageTextLayout_app_text_max_line, -1);
